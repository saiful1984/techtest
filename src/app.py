...
def hello():
    docStr = '''
    Welcome to this app.\n
    If you are able to see this page, then the app is up and its listening to its intend port.
    Docker port:5000
    Host port:8000\n
    You can run the below APIs.
    ...
    You can run the test case script "python test_app.py"
    '''
    return docStr
